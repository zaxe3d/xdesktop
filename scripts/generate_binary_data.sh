...
materials=( "custom.xml.fdm_material" "zaxe_abs.xml.fdm_material" "zaxe_flex_black.xml.fdm_material" "zaxe_flex_white.xml.fdm_material" "zaxe_pla.xml.fdm_material" )
