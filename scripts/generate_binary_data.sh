...
definitions=( "zaxe.def.json" "zaxe_x1.def.json" "zaxe_x2.def.json" "zaxe_x1plus.def.json" "zaxe_z.def.json" "zaxe_new_z.def.json" "zaxe_z1.def.json" "zaxe_z1plus.def.json" "zaxe_z2.def.json" "zaxe_z3.def.json" "zaxe_z3plus.def.json" )
