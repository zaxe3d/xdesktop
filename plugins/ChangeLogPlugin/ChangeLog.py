...
class ChangeLog(Extension, QObject,):
    ...
    def loadChangeLogs(self):
        ...
        with open(os.path.join(PluginRegistry.getInstance().getPluginPath(self.getPluginId()), "ChangeLog_", Application.getInstance().getPreferences().getValue("general/language"), ".txt"), "r", encoding = "utf-8") as f:
            open_version = None
